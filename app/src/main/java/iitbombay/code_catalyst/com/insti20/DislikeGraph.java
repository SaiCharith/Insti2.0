...
/**
 *  This is 2nd Fragment of the Tabbed-activity. This fragment displays the graph with each hostel on X-axis
 *  representend by hostel number and thier corresponding dislikes on Y-axis, so that we can easily analyze.
 *  We have used GraphView API for creating graphs. Number of dislikes for each hostel is accessed in our
